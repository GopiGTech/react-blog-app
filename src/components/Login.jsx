      ...
      <div className="2xl:container mx-auto bg-gray-100">
        <div className="w-[80%] mx-auto flex flex-col items-center justify-center min-h-screen">
          <div className="shadow-2xl p-10 bg-white w-full max-w-sm rounded-md">
            <h1 className="font-sans font-semibold text-5xl text-center mb-9">Login</h1>
            <div className="flex flex-col gap-4">
              <input type="text" placeholder="Email" className=" border-[1px] border-[#787777] rounded-sm p-2 focus:outline-none focus:ring-2 focus:ring-blue-500" onChange={(e) => {
              ...
              <button type="submit" className="border border-blue-700 rounded-sm bg-blue-600 text-white p-2 hover:bg-blue-700" onClick={handleLogin}>Login</button>
            </div>
